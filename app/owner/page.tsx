          ...
          <div className="space-y-3 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white p-4 rounded-2xl border border-zinc-200 shadow-sm">
                <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-1">Laba Bersih Kedai</span>
                <p className="text-sm font-black text-indigo-600">Rp {formatIDR(data.kedai.labaBersih)}</p>
              </div>
              <div className="bg-white p-4 rounded-2xl border border-zinc-200 shadow-sm">
                <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-1">Laba Bersih Gerobak</span>
